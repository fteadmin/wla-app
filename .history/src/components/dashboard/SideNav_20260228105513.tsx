...
export default function SideNav({
  ...
  // Removed local open state; use only props
  ...
  return (
    <>
      ...
      {/* Floating NavBar for mobile removed; control open state from parent */}
      ...
      >
        {/* Close button for mobile removed; control open state from parent */}

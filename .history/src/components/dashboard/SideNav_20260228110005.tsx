  ...
  return (
    <>
      ...
      >
        ...
        <button 
          onClick={onClose}
          className="lg:hidden absolute top-4 right-4 p-2 text-[#a0a0b4] hover:text-white"
        >
          <X size={20} />
        </button>
        ...
        <div className="relative z-10 flex items-center gap-2.5 px-3 pt-5 pb-4 border-b border-[#D9BA84]/10">
          <div className="w-8 h-8 rounded-[9px] bg-gradient-to-br from-[#D9BA84] to-[#c8b450] flex items-center justify-center flex-shrink-0">
        ...
        <div className="relative z-10 p-2 border-t border-[#D9BA84]/10">
          <div className="mb-2 flex items-center gap-2.5 px-3 py-[10px] rounded-xl bg-[#D9BA84]/6 border border-[#D9BA84]/14">
            <div className="w-[30px] h-[30px] rounded-[8px] flex items-center justify-center text-[11px] font-bold text-[#D9BA84] border border-[#D9BA84]/30">
              {memberInitials}
            </div>
